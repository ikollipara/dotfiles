...
;; ## added by OPAM user-setup for emacs / ocp-indent ## 5d8ad39d0755513d4faf0f1bf0c2c4c3 ## you can edit, but keep this line
;; Load ocp-indent from its original switch when not found in current switch
(when (not (member "ocp-indent" opam-tools-installed))
  (autoload 'ocp-setup-indent "/home/ian/.opam/default/share/emacs/site-lisp/ocp-indent.el" "Improved indentation for Tuareg mode")
  (autoload 'ocp-indent-caml-mode-setup "/home/ian/.opam/default/share/emacs/site-lisp/ocp-indent.el" "Improved indentation for Caml mode")
  (add-hook 'tuareg-mode-hook 'ocp-setup-indent t)
  (add-hook 'caml-mode-hook 'ocp-indent-caml-mode-setup  t)
  (setq ocp-indent-path "/home/ian/.opam/default/bin/ocp-indent"))
